...
function pricingCards() {
  const plans = [
    ...
    { key: "premium_month", name: "Premium", price: "$6.99", unit: "/ month", note: "Private calls", popular:true, annual:true, perks:["Everything in Basic","Start private audio or video calls from DMs","Host invite-only rooms for up to 6 people","Up to 2,000 messages and 300 encouragements daily","Priority favorites and Premium badge"] },
